  ...
  useEffect(() => {
    ...
    const updateProgress = () => {
      ...
      if (p < 100) {
        ...
        setIsReady(true); // Show the button instead of finishing automatically
      }
    };
  ...
  return (
    ...
    >
      <div style={{ textAlign: 'center', position: 'relative', zIndex: 20 }}>
        ...
        {/* Progress Bar & Text (Hidden when ready) */}
        {!isReady && (
        ...
        {/* Buka Undangan Button (Shown when ready) */}
        {isReady && (
           <div className="reveal visible" style={{ animation: 'fadeInUp 1s ease forwards' }}>
             <button 
